...
강원특별자치도 태백시 지역 타겟 과외 사이트. GitHub Pages 정적 사이트, 빌드 없음.
홈 `~/CLAUDE.md` 규칙을 그대로 따른다 (세션 하나 = 저장소 하나, 시작 때 pull, 끝날 때 commit+push, 작업로그 기록).

## 도메인 / 배포
- 도메인: **아직 없음**. 현재 주소 `https://x26589334-cpu.github.io/taebaek-tutoring/`
...
| 파일 | 내용 |
|---|---|
| `index.html` | 홈 (히어로 SVG = snow-mountain 모티프) |
